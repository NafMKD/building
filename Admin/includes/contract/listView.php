        ...
        <div class="card">
            <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2 mr-5">
                    <li class="nav-item"><a class="nav-link <?php if (isset($_GET['listViewContract']) && isset($_GET['floor'])) {
                                                                echo "active";
                                                            } ?>" href="?listViewContract&floor">Floor</a></li>
                    <li class="nav-item"><a class="nav-link <?php if (isset($_GET['listViewContract']) && isset($_GET['stat'])) {
                                                                echo "active";
                                                            } ?>" href="?listViewContract&stat">Status</a></li>
                </ul>
            </div>
        </div>
